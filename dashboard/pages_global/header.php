...
<head>
  ...
  <title>Tu Tienda Perú | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>Tu Tienda Perú</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Geovanny Rios</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Bienvenido: Geovanny Rios <!-- Web Developer-->
              ...
              <li class="user-footer">
                ...
                <form id="frmcerrarsesion" action="#" method="POST">
